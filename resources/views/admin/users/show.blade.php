        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-options">
                    <a href="{{ route('dashboard.users.index') }}" class="btn btn-radius btn-danger-light btn-sm">Regresar</a>
                </div>
            </div>
            <div class="card-body text-center">
                    ...
                    <div class="ml-auto mt-xl-2 mt-lg-0 ml-lg-2">
                            <a href="{{ route('dashboard.users.edit', $user) }}" class="btn btn-outline-primary btn-sm mt-1 mb-1"><i class="fe fe-camera mr-1"></i>Edit profile</a>
